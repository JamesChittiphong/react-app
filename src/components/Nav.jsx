        ...
        <div className="lg:hidden block absolute top-16 w-full left-0 bg-slate-900 transition">
            <ul className='text-center text-xl p-20'>
                <Link spy={true} smooth={true} to="Home">
                    <li className='my-4 py-4 border-b border-slate-800 hover:bg-orange-400 hover:rounded spy={true} smooth={true}'>Home</li>
                </Link>
                <Link spy={true} smooth={true} to="About">
                    <li className='my-4 py-4 border-b border-slate-800 hover:bg-orange-400 hover:rounded spy={true} smooth={true}'>About</li>
                </Link>
                <Link spy={true} smooth={true} to="Serivces">
                    <li className='my-4 py-4 border-b border-slate-800 hover:bg-orange-400 hover:rounded spy={true} smooth={true}'>Serivces</li>
                </Link>
                <Link spy={true} smooth={true} to="Projects">
                    <li className='my-4 py-4 border-b border-slate-800 hover:bg-orange-400 hover:rounded spy={true} smooth={true}'>Projects</li>
                </Link>
                <Link spy={true} smooth={true} to="Contact">
                    <li className='my-4 py-4 border-b border-slate-800 hover:bg-orange-400 hover:rounded spy={true} smooth={true}'>Contact</li>
                </Link>
            </ul>
        </div>
    </>
        ...
        <div className="lg:flex md:flex lg:flex-1 items center justify-end font-normal hidden">
            <div className="flex-10">
                <ul className="flex gap-8 mr-16 text-{18px}">
                    ...
                    <Link spy={true} smooth={true} to="Serivces">
                        <li className='hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer'>Serivces</li>
                    </Link>
                    <Link spy={true} smooth={true} to="Projects">
